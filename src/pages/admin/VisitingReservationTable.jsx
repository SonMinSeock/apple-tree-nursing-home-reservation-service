...
const VisitingReservationTable = () => {
  const navigate = useNavigate();
  const [reservations, setReservations] = useState([]);
  const [currentDate, setCurrentDate] = useState(new Date());

  const days = ["월요일", "화요일", "수요일", "목요일", "금요일", "토요일", "일요일"];
  const times = ["오전 10:30", "오전 11:00", "오후 14:00", "오후 15:00", "오후 16:00"];
                ...
                <Cell
                  ...
                  onClick={() =>
                    navigate("/admin/reservation-detail", {
                      state: { type: "면회", reservations: slots, date: dates[dayIndex], day: days[dayIndex] },
                    })
                  }
...
export default VisitingReservationTable;
